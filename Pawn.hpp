...
// Author: Kenny Zhou
// Date: 2/10/2025
// A header file that declares a Pawn class, extending the ChessPiece class through specicialized characteristics of a pawn
...
public:
    ...
    */
    Pawn(const std::string& color, const int& row, const int& column, const bool& movingUp, const bool& double_jumpable_);
