...
// Author: Kenny Zhou
// Date: 2/10/2025
// A header file that declares a class, Rook that extends the ChessPiece class. This class defines the specical characteristics of a rook chess piece.
...
public: 
    ...
    */
    Rook(const std::string& color, const int& row = -1, const int& column = -1, const bool& movingUp = false, const int& castle_moves_left = 3git );
